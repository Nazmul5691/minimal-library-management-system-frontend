...
export default function Authors() {
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 font-inter text-gray-800 dark:text-gray-100 pt-24 pb-16">
            
            <section className="container mx-auto px-6">
                <div className="flex items-center justify-center mb-10 text-indigo-600 dark:text-indigo-400"> 
                    <PencilRuler className="w-10 h-10 mr-3" />
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100">Meet the Storytellers</h2> 
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {mockAuthors.map((author) => (
                        <div
                            key={author.id}
                            className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-2xl p-8 flex flex-col items-center text-center transform transition-transform duration-300 hover:scale-[1.03] hover:shadow-2xl dark:hover:shadow-3xl border border-gray-100 dark:border-gray-700" 
                        >
                            <img
                                src={author.imageUrl}
                                alt={author.name}
                            ...
                            <div className="flex items-center text-indigo-700 dark:text-indigo-400 mb-4"> 
            ...
            <section className="text-center py-12 mt-16 mx-auto px-6 bg-purple-50 dark:bg-purple-900 rounded-2xl shadow-inner dark:shadow-md border border-purple-100 dark:border-purple-800 max-w-4xl"> 
                <h2 className="text-3xl font-bold text-purple-800 dark:text-purple-200 mb-4">Can't find your favorite author?</h2> 
