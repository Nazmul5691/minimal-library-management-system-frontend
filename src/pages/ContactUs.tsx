            ...
            <div className="pt-5 lg:pt-10 flex flex-col lg:flex-row items-center justify-center gap-8">
                <div className="w-full">
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="max-w-xs mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
                            <div className="flex flex-col items-center p-6">
                                <div className="text-blue-700 dark:text-blue-400 text-4xl mb-4">
                                    <FaMobileAlt className="w-10 h-10" />
                                </div>
                                <h3 className="text-xl lg:text-2xl font-semibold text-gray-900 dark:text-gray-100">
                                    +44 (0) 1154 5470946
                                </h3>
                            ...
                            <div className="h-1 bg-purple-500 dark:bg-purple-700 mt-4"></div>
                        </div>
